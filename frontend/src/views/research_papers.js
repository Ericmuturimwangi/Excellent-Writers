  ...
  useEffect(() => {
    const generateEssays = () => {
      ...
      for (let i = 1; i <= essayCount; i++) {
        essaysArray.push({
          id: i,
          title: `Academic Paper ${i}: Research Paper`,
          content: `Abstract for Paper ${i}. This research paper, authored by esteemed scholars in environmental science, investigates the effects of climate change on coastal ecosystems. The study aims to understand how rising sea levels and increased storm frequency affect biodiversity and habitat stability.`,
        });
      }
